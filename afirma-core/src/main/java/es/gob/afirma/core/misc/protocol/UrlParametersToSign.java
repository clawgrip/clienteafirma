...
public final class UrlParametersToSign extends UrlParameters {
	 ...
	 * la <code>PrivateKeyEntry</code> fijada. */
	...
	private static final String[] KNOWN_PARAMETERS = {
			...
			STORAGE_SERVLET_PARAM, KEY_PARAM, FILE_ID_PARAM, KEYSTORE_PARAM,
	 ...
	 * de firma indicando si es necesario proporcionar la URL del servicio para transmitir el resultado.
	...
	void setSignParameters(final Map<String, String> params) throws ParameterException {
		...
		// Si hemos recibido el identificador para la descarga de la configuracion, no encontraremos el resto de parametros
		if (getFileId() != null) {
			return;
		}
