...
public final class ProtocolInvocationUriParser {
	 ...
	 * @return Par&aacute;metros.
	 * @throws ParameterException Si alg&uacute;n par&aacute;metro proporcionado es incorrecto. */
	public static UrlParametersToSign getParametersToSign(final String uri, final boolean servicesRequired) throws ParameterException {
		return ProtocolInvocationUriParserUtil.getParametersToSign(parserUri(uri), servicesRequired);
	}
	 ...
	 * @return Par&aacute;metros
	 * @throws ParameterException Si alg&uacute;n par&aacute;metro proporcionado es incorrecto. */
	public static UrlParametersToSign getParametersToSign(final byte[] xml, final boolean servicesRequired) throws ParameterException {
		return ProtocolInvocationUriParserUtil.getParametersToSign(ProtocolInvocationUriParserUtil.parseXml(xml), servicesRequired);
	}
	 ...
	 * @return Par&aacute;metros.
	 * @throws ParameterException Si alg&uacute;n par&aacute;metro proporcionado es incorrecto. */
	public static UrlParametersToSignAndSave getParametersToSignAndSave(final String uri, final boolean servicesRequired) throws ParameterException {
		return ProtocolInvocationUriParserUtil.getParametersToSignAndSave(parserUri(uri), servicesRequired);
	}
	 ...
	 * @return Par&aacute;metros.
	 * @throws ParameterException Si alg&uacute;n par&aacute;metro proporcionado es incorrecto. */
	public static UrlParametersToSelectCert getParametersToSelectCert(final String uri, final boolean servicesRequired) throws ParameterException {
		return ProtocolInvocationUriParserUtil.getParametersToSelectCert(parserUri(uri), servicesRequired);
	}
	 ...
	 * @return Par&aacute;metros
	 * @throws ParameterException Si alg&uacute;n par&aacute;metro proporcionado es incorrecto. */
	public static UrlParametersToSelectCert getParametersToSelectCert(final byte[] xml, final boolean servicesRequired) throws ParameterException {
		return ProtocolInvocationUriParserUtil.getParametersToSelectCert(ProtocolInvocationUriParserUtil.parseXml(xml), servicesRequired);
	}
	 ...
	 * @return Par&aacute;metros
	 * @throws ParameterException Si alg&uacute;n par&aacute;metro proporcionado es incorrecto. */
	public static UrlParametersToSave getParametersToSave(final byte[] xml, final boolean servicesRequired) throws ParameterException {
		return ProtocolInvocationUriParserUtil.getParametersToSave(ProtocolInvocationUriParserUtil.parseXml(xml), servicesRequired);
	}
	 ...
	 * @return Par&aacute;metros
	 * @throws ParameterException Si alg&uacute;n par&aacute;metro proporcionado es incorrecto. */
	public static UrlParametersToSave getParametersToSave(final String uri, final boolean servicesRequired) throws ParameterException {
	 ...
	 * @return Par&aacute;metros
	 * @throws ParameterException Si alg&uacute;n par&aacute;metro proporcionado es incorrecto. */
	public static UrlParametersForBatch getParametersToBatch(final byte[] xml, final boolean servicesRequired) throws ParameterException {
		return ProtocolInvocationUriParserUtil.getParametersToBatch(ProtocolInvocationUriParserUtil.parseXml(xml), servicesRequired);
	}
	 ...
	 * @return Par&aacute;metros.
	 * @throws ParameterException Si alg&uacute;n par&aacute;metro proporcionado es incorrecto. */
	public static UrlParametersForBatch getParametersToBatch(final String uri, final boolean servicesRequired) throws ParameterException {
