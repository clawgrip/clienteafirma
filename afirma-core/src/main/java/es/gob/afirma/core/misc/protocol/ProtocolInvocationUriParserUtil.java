...
public final class ProtocolInvocationUriParserUtil {
	...
	public static UrlParametersToSave getParametersToSave(final Map<String, String> params, final boolean servicesRequired) throws ParameterException {
	 ...
	 * @throws ParameterException Si alg&uacute;n par&aacute;metro proporcionado es incorrecto. */
	public static UrlParametersToSign getParametersToSign(final Map<String, String> params, final boolean servicesRequired) throws ParameterException {
