...
public final class UrlParametersForBatch extends UrlParameters {
	...
	/** Crea el conjunto de par&aacute;metros necesario para el uso de la operaci&acute;n de firma de lotes indicando
	 * si es necesario proporcionar la URL del servicio para el guardado del resultado.
